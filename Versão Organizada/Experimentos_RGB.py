...
NOISE_EXPERIMENTS = {
    ...
    "Color Moiré": {
        "experiment": True,
        "levels": [0.0, 0.1, 0.2, 0.3], # 0.1, 0.2, 0.3
...
# # Salvar em Excel
# output_path = "resultados_" + image_name + "_ruidos_entropia_complexidade.xlsx"
# df_all.to_excel(output_path, index=False, engine="openpyxl")

# %%%%%%%%%%%%%%%%%%%%%%%%%%%% PLOT RESULTADOS %%%%%%%%%%%%%%%%%%%%%%%%%%%%

PLOT_DIR = "C:/Users/givan/OneDrive/Área de Trabalho/Github/[Versão Final] PPGI_UFAL/Experimento Fabi/plots_final/"
