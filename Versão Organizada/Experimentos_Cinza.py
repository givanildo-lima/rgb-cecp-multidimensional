...
#os.chdir("C:/Users/givan/OneDrive/Área de Trabalho/Github/[Versão Final] PPGI_UFAL/Experimento Fabi/")

dx = 2
dy = 2
D = dx * dy

def calc_entropy_complexity(img):
    img_gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
    ent, comp = ordpy.get_entropy_complexity(img_gray, dx=dx, dy=dy, taux=1, tauy=1)
    return ent, comp
...
# # Salvar em Excel
# output_path = "unv_resultados_" + image_name + "_ruidos_entropia_complexidade.xlsx"
# df_all.to_excel(output_path, index=False, engine="openpyxl")

#%%

PLOT_DIR = "C:/Users/givan/OneDrive/Área de Trabalho/Github/[Versão Final] PPGI_UFAL/Experimento Fabi/plots_final/UNV/"
...
# plt.savefig(
#     os.path.join(PLOT_DIR, "UNV_" + image_name + "_mvacecp_trajectories_all_noises.png"),
#     dpi=300,
#     bbox_inches="tight"
# )
# plt.savefig(
#     os.path.join(PLOT_DIR, "UNV_" + image_name + "_mvacecp_trajectories_all_noises.pdf"),
#     dpi=300,
#     bbox_inches="tight"
# )
...
# =====================================================
# DICIONÁRIOS DE TRADUÇÃO (APENAS PARA ESTE PLOT)
# =====================================================
LEGEND_TRANSLATION = {
...
# Reordenar legenda (estrela primeiro)
...
# Ajuste conforme necessário para UNV
x1, x2, y1, y2 = 0.74, 1.0, 0.0, 0.25
#LENA = 0.74, 1.0, 0.0, 0.25
#ROCKET = 0.49, 0.91, 0.1, 0.25
#CHECKERBOARD = 0.05, 0.4, 0.05, 0.25
...
# fig.savefig(
#     os.path.join(PLOT_DIR, "UNV_" + image_name + "_mvacecp_trajectories_with_inset.png"),
#     dpi=300,
#     bbox_inches="tight"
# )

# fig.savefig(
#     os.path.join(PLOT_DIR, "UNV_" + image_name + "_mvacecp_trajectories_with_inset.pdf"),
#     dpi=300,
#     bbox_inches="tight"
# )
